...
public:
  ...
  virtual void render_to_file(std::string filename, size_t x, size_t y,
                              size_t dx, size_t dy) = 0;
   ...
   */
  virtual void save_image(std::string filename = "",
                          ImageBuffer *buffer = NULL) = 0;
